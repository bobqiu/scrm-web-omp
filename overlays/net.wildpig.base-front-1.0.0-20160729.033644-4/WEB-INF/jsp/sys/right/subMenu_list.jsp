...
<html lang="zh-CN">
	...
	<body>
			<div class="row">
				<ol class="breadcrumb" style="border-bottom: 1px solid #0088cc;">
					...
					<li><a href="javascript: void(0)">菜单信息</a></li>
				</ol>
			</div>
	<div class="row">
		<form class="form-horizontal" data-bt-form>
			<input type="hidden" name="menuType" value="2" />
			<input type="hidden" name="parentId" value="${pd.menuId}" />
			<div class="col-sm-4">
	...
	<div id="toolbar">
		...
		<button type="button" class="btn btn-primary btn-sm"
			data-url="right/addMenu?parentId=${pd.menuId}"
	...
	<script type="text/javascript">
		function actionFormatter(value, row, index) {
			...
			html += '<button class="btn btn-info btn-xs" data-url="right/button?menuId=' + row.menuId + '" data-target="navTab" title="查看按钮"><i class="glyphicon glyphicon-zoom-in"></i> 查看按钮</button> ';
			</shiro:hasPermission>
			...
			html += '<button class="btn btn-danger btn-xs" data-url="right/deleteMenu?menuId=' + row.menuId+'" data-msg="将删除该菜单下的所有按钮，确定删除吗？" data-model="ajaxToDo" data-targetid="my_delete_modal" title="删除"><i class="glyphicon glyphicon-remove"></i>删除</button> ';
			</shiro:hasPermission>
			return html;
		}
	</script>
