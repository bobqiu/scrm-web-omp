...
<head>
    <meta charset="utf-8">
    <title>chain-workmachine-list</title>
</head>
	...
	<div class="row">
	 ...
	 <div class="row">
		  <ul class="nav nav-pills" style="border-bottom:1px solid #ccc;">
			  <li><a href="<%=basePath%>org/chainOrg/detail?id=${id}" data-target="navTab">机构详情</a></li>
...
<div class="row">
    <table  data-bt-table data-url="org/chainOrg/detail/form?id=${id}"
