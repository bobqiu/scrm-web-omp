...
<div class="row">
    <ol class="breadcrumb" style="border-bottom: 1px solid #0088cc;">
        ...
        <li><a href="javascript: void(0)">新增单店</a></li>
    </ol>
</div>
...
<form action="" class="form-horizontal" id="orgForm" style="padding-left: 150px;">
    <div class="form-group">
        <label  class="col-md-2 control-label float-right">单店全称<span class="error">*</span></label>
        <div class="col-md-6">
            <input type="text" class="form-control" id="orgFullName" placeholder="1-50位汉字、英文、数字、符号及组合">
        </div>
    </div>
    <div class="form-group">
        <label  class="col-md-2 control-label float-right">单店简称<span class="error">*</span></label>
        <div class="col-md-6">
...
$(function(){
    ...
    $('#orgForm').submit(function (e) {
        ...
        $.ajax({
            ...
            url:basePath + 'org/singleOrgAdd',
            data:JSON.stringify(data),
            success:function (res) {
                $("#navTab").load('org/singleOrg');
                console.log(res)
            }
        })
    })
