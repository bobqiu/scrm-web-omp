...
<body>
	...
	<div class="row">
	    <ol class="breadcrumb" style="border-bottom: 1px solid #0088cc;">
	        ...
	        <li><a href="<%=basePath%>org/chainOrg" data-target="navTab">连锁机构列表</a></li>
	        <li><a href="javascript: void(0)">机构详情</a></li>
	    </ol>
	</div>
	
	 <div class="row">
		  <ul class="nav nav-pills" style="border-bottom:1px solid #ccc;">
			  <li class="active"><a href="javascript: void(0)">机构详情</a></li>
			  <li><a href="<%=basePath%>org/chainOrg/detail/list?id=${id}" data-target="navTab">工作机（${workTotalCount }）</a></li>
		 </ul>
      ...
      <div class="czf-vip-member-data-main clearfix">
        ...
        <div class="vip-main-right">
            <p>&nbsp;&nbsp;&nbsp;机构全称：${dto.orgFullName}</p>
            <p>&nbsp;&nbsp;&nbsp;机构简称：${dto.orgName}</p>
            <p>&nbsp;&nbsp;&nbsp;机构账号：${dto.orgAccount}</p>
